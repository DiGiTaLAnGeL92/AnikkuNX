...
g++ -std=c++17 -O1 -Isrc -Ilibrary/borealis/library/include/borealis/extern -Ilibrary/gumbo tools/sourcetest.cpp src/net/http.cpp src/html/html.cpp src/sources/*.cpp src/util/crypto.cpp src/util/unpacker.cpp \
  build_test/gumbo.a -lcurl -o build_test/sourcetest.exe
